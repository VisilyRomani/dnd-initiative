    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-auto">
        <div className="grid grid-cols-3 h-full bg-zinc-800 gap-3">
          ...
          className="text-indigo-500 whitespace-nowrap hover:text-white border border-indigo-500 hover:bg-indigo-500 focus:ring-2 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 h-12 text-center dark:border-blue-500 dark:hover:text-white dark:hover:bg-indigo-500 m-1"
