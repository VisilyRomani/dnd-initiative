...
import Icon from './assets/icons/icon-list.ico';
    ...
    <>
      <div className="py-0.5 flex justify-between draggable">
        <div className="inline-flex">
          <img className="h-6 mr-3 p-1" src={Icon} alt="Icon of Electron" />
          <p className="text-xs md:pt-1 md:-ml-1 lg:-ml-2">DnD Initiative Tracker</p>
        </div>
